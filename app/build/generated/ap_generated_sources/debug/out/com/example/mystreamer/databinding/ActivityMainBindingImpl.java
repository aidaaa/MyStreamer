...
import com.example.mystreamer.BR;
import androidx.annotation.NonNull;
import androidx.annotation.Nullable;
import android.view.View;
@SuppressWarnings("unchecked")
public class ActivityMainBindingImpl extends ActivityMainBinding implements com.example.mystreamer.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.timeVm == variableId) {
            setTimeVm((com.example.mystreamer.dataBinding.TimeViewModel) variable);
        }
        else if (BR.dateVm == variableId) {
            setDateVm((com.example.mystreamer.dataBinding.DateViewModel) variable);
        }
        else if (BR.activity == variableId) {
            setActivity((com.example.mystreamer.MainActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setTimeVm(@Nullable com.example.mystreamer.dataBinding.TimeViewModel TimeVm) {
    ...
    public void setDateVm(@Nullable com.example.mystreamer.dataBinding.DateViewModel DateVm) {
    ...
    public void setActivity(@Nullable com.example.mystreamer.MainActivity Activity) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeTimeVm((com.example.mystreamer.dataBinding.TimeViewModel) object, fieldId);
            case 1 :
                return onChangeDateVm((com.example.mystreamer.dataBinding.DateViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeTimeVm(com.example.mystreamer.dataBinding.TimeViewModel TimeVm, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeDateVm(com.example.mystreamer.dataBinding.DateViewModel DateVm, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.example.mystreamer.dataBinding.TimeViewModel timeVm = mTimeVm;
        ...
        com.example.mystreamer.dataBinding.DateViewModel dateVm = mDateVm;
