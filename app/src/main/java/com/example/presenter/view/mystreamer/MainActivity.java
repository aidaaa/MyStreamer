package com.example.presenter.view.mystreamer;
...
import com.example.presenter.view.mystreamer.adapter.ShowChannelAdapter;
import com.example.presenter.view.mystreamer.dagger.app.App;
import com.example.presenter.view.mystreamer.dataBinding.DateViewModel;
import com.example.presenter.view.mystreamer.dataBinding.TimeViewModel;
import com.example.presenter.view.mystreamer.databinding.ActivityMainBinding;
import com.example.presenter.view.mystreamer.encrypteplayer.MyAesCipherDataSource;
import com.example.presenter.view.mystreamer.xml.Xml;
    ...
    public void setUpViewUrl(String url) {
        ...
        simpleExoPlayer.addListener(new Player.EventListener() {
            ...
            public void onPlayerError(ExoPlaybackException error) {
                prg_bar.setVisibility(View.INVISIBLE);
                if (error.getMessage().equals("com.google.android.exoplayer2.upstream.Loader$UnexpectedLoaderException: Unexpected NullPointerException: Attempt to invoke virtual method 'void javax.crypto.CipherInputStream.close()' on a null object reference"))
                    Toast.makeText(MainActivity.this, "فایل در زمان و تاریخ انتخابی وجود ندارد", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(MainActivity.this, "در پخش مشکلی پیش آمده مجدد تلاش کنید", Toast.LENGTH_LONG).show();
